export { default as ConsumerLayout } from '../Layouts/Consumer';
export { default as ConsumerDashboard } from './Dashboard';
export { default as ConsumerOrders } from './Orders';
export { default as ConsumerProfile } from './Profile';

export { default as ConsumerCreateOrder } from './CreateOrder';
