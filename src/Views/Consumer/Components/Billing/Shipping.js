        ...
        <div>
            ...
            <form>
                ...
                <div className="mb-3 row">
                    ...
                    <div className="col-sm-9"><input onChange={(e)=>handle_change(e.target)}  value={props.shippingAddress?.billing_street} name="street" type="text" className="form-control" id="" placeholder="street" /></div>
                </div>
                <div className="mb-3 row">
