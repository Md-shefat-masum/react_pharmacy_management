        ...
        <div className="page-sidebar custom-scrollbar page-sidebar-open">
            ...
            <ul className="sidebar-menu">
                <li>
                    ...
                    <Link to="/dispensary" className="sidebar-header">
                        <i className="icon-notepad"></i> 
                        <span>Dasboard</span>
                    </Link>
                    <Link to="/dispensary/profile" className="sidebar-header">
                ...
                <li>
                    ...
                    <Link to="/dispensary/create-order" className="sidebar-header">
                        <i className="icon-shopping-cart-full"></i>
                        <span>Create Order</span>
                    </Link>
                    <Link to="/dispensary/orders" className="sidebar-header">
                        <i className="icon-briefcase"></i>
                        <span>Orders</span>
                    </Link>
                    <Link to="/dispensary/prescriptions" className="sidebar-header">
                        <i className="icon-briefcase"></i>
                        <span>Prescriptions</span>
                    </Link>
                    <Link to="/dispensary/inventory" className="sidebar-header">
                        <i className="icon-briefcase"></i>
                        <span>Inventory</span>
                    </Link>
                </li>
