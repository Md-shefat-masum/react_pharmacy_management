...
function CreateManufacturer() {
    ...
    const formHandler = (e) => {
        ...
        axios.post(`${process.env.REACT_APP_API_LINK}/inventory/manufacturer/create`, form_data)
            .then(() => {
                e.target.reset();
                calert(true, 'Manufacturer created successfully.', 'light', 4000);
            })
            .catch((error) => {
                                ...
                                <div className="form-group">
                                    <div className="mb-3 row">
                                        ...
                                        <div className="col-sm-9">
                                            <input type="text" name="name" className="form-control" placeholder="Manufacturer name" />
                                            {
                                    ...
                                    <div className="mb-3 row">
                                        ...
                                        <div className="col-sm-9">
                                            <textarea type="text" name="description" className="form-control" placeholder="Manufacturer Description" />
                                            {
