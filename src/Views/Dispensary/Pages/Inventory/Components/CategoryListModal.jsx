...
function CategoryListModal(props) {
    ...
    useEffect(() => {
        LoadData({ page: 1 });
        setSelectedCategories([...props.categoryIds.ids])
        setSelectedCategoryDetails([...props.categoryIds.details])
        return () => {
    ...
    useEffect(() => {
        props.setCategoryIds({ ids: selectedCategories, details: selectedCategoryDetails })
        return () => {
