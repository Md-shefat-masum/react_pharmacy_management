...
function EditStorage() {
    ...
    const formHandler = (e) => {
        ...
        axios.post(`${process.env.REACT_APP_API_LINK}/inventory/storage/update`, form_data)
            .then(() => {
                // e.target.reset();
                calert(true, 'Storage updated successfully.', 'light', 4000);
            })
            .catch((error) => {
                            ...
                            <form action="" onSubmit={(e) => formHandler(e)}>
                                <div className="form-group">
                                    <div className="mb-3 row">
                                        <label htmlFor="" className="col-sm-3 col-form-label">Storage Name :</label>
                                    ...
                                    <div className="mb-3 row">
                                        <label htmlFor="" className="col-sm-3 col-form-label">Storage Description :</label>
                                        <div className="col-sm-9">
