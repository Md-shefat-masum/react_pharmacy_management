...
function AllStorage() {
    ...
    const delete_data = (id) => {
        ...
        axios.post(`${process.env.REACT_APP_API_LINK}/inventory/storage/delete`,{id})
            .then(() => {
                LoadData({ page: 1 });
                            ...
                            return <tr key={item.id}>
                                ...
                                <td style={{ width: 350 }}>
                                    <div className="d-flex flex-wrap">
                                        <Link to={"/dispensary/inventory/storages/details/"+item.id} className="btn m-2 btn-air-secondary">Details</Link>
                                        <Link to={"/dispensary/inventory/storages/edit/"+item.id} className="btn m-2 btn-air-success">Edit</Link>
